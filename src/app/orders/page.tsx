  ...
  return (
    <FlexColumn spacing={2}>
      ...
      <div className="flex justify-center items-center gap-2 my-4">
        <button className="w-9 h-9 flex items-center justify-center rounded border border-slate-300 hover:bg-slate-100">
          <ChevronLeft className="h-4 w-4" />
        </button>
        <button className="w-9 h-9 flex items-center justify-center rounded border border-slate-300 hover:bg-slate-100">
          1
        </button>
        <button className="w-9 h-9 flex items-center justify-center rounded bg-blue-600 text-white">
          2
        </button>
        <button className="w-9 h-9 flex items-center justify-center rounded border border-slate-300 hover:bg-slate-100">
          3
